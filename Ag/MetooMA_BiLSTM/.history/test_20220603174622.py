...
api = tweepy.Client(consumer_key= consumer_key,consumer_secret= consumer_secret,access_token= access_key,access_token_secret= access_token_secret)

api = tweepy.API(auth)
api.get_tweet(id=1015249783408164864)