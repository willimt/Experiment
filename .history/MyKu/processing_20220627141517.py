...
DATASET_PATH = 'C:/Users/Administrator/Documents/Experiment/datasets'
ORIGIN_DATASET_PATH = 'C:/Users/Administrator/Documents/Experiment/origin_datasets'

#datasets path
EXIST2021 = 'C:/Users/Administrator/Documents/Experiment/datasets/EXIST2021'
TRAIN_EXIST2021 = EXIST2021 + '/train.tsv'
TEST_EXIST2021 = EXIST2021 + '/test.tsv'

EMBEDDING_PATH = 'C:/Users/Administrator/Documents/Experiment/wordembedding/'
...
HASOC2020数据集加载函数
"""
def set_hasoc2020_train_data(origin_hasoc_2020):
    training_data = pd.read_csv(origin_hasoc_2020)
    for index in range(len(training_data)):
        text = training_data.iloc[index]['text']
        text = Pre_processing_tweets().clean_unuseful
