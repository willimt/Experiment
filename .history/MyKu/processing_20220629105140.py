...
def load_hasoc2020():
    ...
    en_train_text, en_train_label = get_hasoc2020_data(HASOC_2020 + '/hasoc_2020_en_test.xlsx')
    en_train_text, en_train_label = get_hasoc2020_data(HASOC_2020 + '/hasoc_2020_de_train.xlsx')
    en_train_text, en_train_label = get_hasoc2020_data(HASOC_2020 + '/hasoc_2020_de_test.xlsx')
    en_train_text, en_train_label = get_hasoc2020_data(HASOC_2020 + '/hasoc_2020_hi_train.xlsx')
    en_train_text, en_train_label = get_hasoc2020_data(HASOC_2020 + '/hasoc_2020_hi_test.xlsx')
