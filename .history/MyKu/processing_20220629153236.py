...
def load_hasoc2020():
    en_train_data = get_hasoc2020_data(HASOC_2020 + '/hasoc_2020_de_train.xlsx')
    ...
    return get_hasoc2020_data(HASOC_2020 + '/hasoc_2020_en_train.xlsx'), get_hasoc2020_data(HASOC_2020 + '/hasoc_2020_en_test.xlsx'), (de_train_text, de_train_label), (de_test_text, de_test_label), (hi_train_text, hi_train_label), (hi_test_text, hi_test_label)
