...
def load_hasoc2020():
    ...
    return (en_train_text, en_train_label), (en_test_text, en_test_label, de_train_text, de_train_label, de_test_text, de_test_label, hi_train_text, hi_train_label, hi_test_text, hi_test_label
