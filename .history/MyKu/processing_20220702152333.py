...
def load_hasoc2020():
    ...
    hi_train_data = get_hasoc2020_data(HASOC_2020 + '/hasoc_2020_de_train.xlsx')
    hi_test_data = get_hasoc2020_data(HASOC_2020 + '/hasoc_2020_de_test.xlsx')
    return en_train_data, en_test_data, de_train_data, de_test_data, hi_train_data, hi
